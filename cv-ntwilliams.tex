...
\begin{document}
    ...
    \begin{tablist}
        ...
        \item[2026] \tab \textbf{Williams, N. T.}, Hines, O. J. and Rudolph, K. E. \enquote{Riesz representers for the rest of us.} Accepted for publication in \textit{Epidemiology}.
    ...
    \item[2026] \tab Rudolph, K.E., Inose, S., \textbf{Williams, N.T.}, Díaz, I., Calderon, L., Torres, J.M., Kioumourtzoglou, M. \enquote{Everything all at once: On choosing an estimand for multi-component environmental exposures.} Accepted for publication in \textit{Epidemiology}.
    ...
    \item[2026] \tab \textbf{Williams, N.}, Schuler, A. \enquote{Improving reproducibility by controlling random stability in machine learning based estimation via bagging.} \textit{arXiv preprint 2604.17694}.

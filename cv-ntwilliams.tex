...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item Nonparametric causal inference methodology for stochastic treatment policies.

        \item Open source statistical software development with a focus on the user experience of the applied statistician.
    ...
    \begin{tablist}
    	...
    	\item[2021] \tab Winston, G., Guadix, S., Lavieri, M., Uribe-Cardenas, R., Kocharian, G., \textbf{Williams, N.}, Sholle, E., Grinspan, Z., and Hoffman, C. \enquote{Closed-Loop Vagal Nerve Stimulation for Intractable Epilepsy: A Single-Center Experience.} Under review at \textit{Seizure: European Journal of Epilepsy}, Winter 2021. 
    
        \item[2020] \tab Goel, A.R., Bruce, H.A, \textbf{Williams, N.} and Alexiades, G. \enquote{Long-Term Effects of Hearing Aids on Hearing Ability in Patients with Sensorineural Hearing Loss} Under review at \textit{Journal of the American Academy of Audiology}, Fall 2020.
    ...
    \item[2020] \tab Day, J., Chrea, B., and \textbf{Williams, N.} \enquote{Fixation versus Non-Fixation of Posterior Malleolus Fractures.} Target: \textit{Foot and Ankle International}, Fall 2020.

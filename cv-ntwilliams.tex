...
\begin{document}
    ...
    \begin{tablist}
        	...
        	\item[2023] \tab \textbf{Williams, N.}, Hoffman, K, Rudolph, K.E., and Díaz, I. \enquote{Learning optimal dynamic treatment regimes from longitudinal data.} In press at \textit{American Journal of Epidemiology}.
    ...
    \begin{tablist}
    	...
    	\item[2023] \tab \enquote{Studying complex and/or longitudinal exposures using
